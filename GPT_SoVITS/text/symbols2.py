...
# symbols2.py  (Vietnamese + English phoneme version)
...
# -----------------------
# Vietnamese Rimes (no tone)
# -----------------------
vi_rimes = [
    "a","ă","â","e","ê","i","o","ô","ơ","u","ư","y",
    "ai","ao","au","ay","âu","eo","êu",
    "am","an","ang","anh","ap","at","ac",
    "ăm","ăn","ăng","âp","ât","âc","ân","âng",
    "em","en","eng","ep","et","ec",
    "im","in","inh","ip","it","ic",
    "om","on","ong","op","ot","oc",
    "ôm","ôn","ông","ơm","ơn","ưng",
